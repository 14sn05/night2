...
return '•اصدار سورس نايت وينق  : *v'..version..'* .'
end
...
sendMsg(msg.chat_id_,msg.id_,'•**عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس نايت وينق يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم .')
end  
else
...
return [[
  [ -:Sourcs Nightwing ](https://t.me/nightwingsource)
  [ -:مطور السورس ](https://t.me/xxxli)
